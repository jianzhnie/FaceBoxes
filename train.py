...
parser.add_argument('--negposratio', default=7, type=int, help='negposratio is setted for sample')
parser.add_argument('--overlap', default=0.35, type=float, help='overlap threshold for match, and negative smaple')
parser.add_argument('--gamma', default=0.1, type=float, help='Gamma update for SGD')
parser.add_argument('--save_folder', default='weights', help='Location to save checkpoint models')
parser.add_argument('--half', default=True, help='decide to train with half or fp32')
parser.add_argument('--warmup_epoch', default=-1, type=int, help='using warmup to adjust learning rate before the seted epoch ')
...
criterion = MultiBoxLoss(num_classes, args.overlap, True, 0, True, args.negposratio, args.overlap, False)
...
def train():
    ...
    for iteration in range(start_iter, max_iter):
        if iteration % epoch_size == 0:
            ...
            if (epoch % 5 == 0 and epoch > 0) or (epoch % 2 == 0 and epoch > 50):
